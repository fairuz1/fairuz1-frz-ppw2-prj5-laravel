...
<div class="alert alert-primary alert-dismissible fade show login-alert" role="alert">
    ...
    <?php endif; ?>
    <h4 class="alert-heading"><b>Welcome to About page!</b></h4>
    <p> Congratulation <b><?php echo e(Auth::user()->name); ?></b>, you have reached the about page. This is the last routing pages!</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fairuzakbarazaria/proyek_tugas1/resources/views/about.blade.php ENDPATH**/ ?>